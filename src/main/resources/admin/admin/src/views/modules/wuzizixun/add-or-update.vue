    ...
    >
      ...
      <el-col :span="12">
        ...
        <div v-else>
          ...
          <el-row>
            <el-col :span="24">
              <el-form-item v-if="type!='info'"  label="资讯信息" prop="zixunxinxi">
                <editor 
                    style="min-width: 200px; max-width: 600px;"
                    v-model="ruleForm.zixunxinxi" 
                    class="editor" 
                    action="file/upload">
                </editor>
              </el-form-item>
              <div v-else>
                <el-form-item v-if="ruleForm.zixunxinxi" label="资讯信息" prop="zixunxinxi">
                    <span v-html="ruleForm.zixunxinxi"></span>
                </el-form-item>
              </div>
            </el-col>
          </el-row>
...
export default {
  ...
  methods: {
    ...
    init(id,type) {
      ...
      if(this.type=='info'||this.type=='else'){
	    ...
	    this.ro.tupian = true;
          ...
          if(o=='zixunxinxi'){
            this.ruleForm.zixunxinxi = obj[o];
	    this.ro.zixunxinxi = true;
            continue;
          }
          if(o=='faburiqi'){
	...
	this.ruleForm.zixunxinxi = this.ruleForm.zixunxinxi.replace(reg,'../../../springboot5j0wf/upload');
        } else {
          this.$message.error(data.msg);
        }
      });
    ...
    onSubmit() {
      ...
      this.$refs["ruleForm"].validate(valid => {
        if (valid) {
          this.$http({
            url: `wuzizixun/${!this.ruleForm.id ? "save" : "update"}`,
            method: "post",
            data: this.ruleForm
          }).then(({ data }) => {
            if (data && data.code === 0) {
              this.$message({
                ...
                onClose: () => {
                  ...
                  this.parent.wuzizixunCrossAddOrUpdateFlag = false;
                  this.parent.search();
