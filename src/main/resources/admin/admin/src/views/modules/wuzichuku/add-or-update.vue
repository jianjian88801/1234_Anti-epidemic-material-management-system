<template>
  <div class="addEdit-block">
    ...
    >
      <el-row>
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'" label="出库单号" prop="chukudanhao">
            <el-input v-model="ruleForm.chukudanhao" 
                placeholder="出库单号" readonly></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" v-if="ruleForm.chukudanhao" label="出库单号" prop="chukudanhao">
              <el-input v-model="ruleForm.chukudanhao" 
                placeholder="出库单号" readonly></el-input>
          </el-form-item>
        </div>
